class LocationsController < ApplicationController
  ...
  before_action :set_location, only: [:show, :edit, :update, :destory]
  ...
  def correct_user
    ...
    redirect_to locations_path, notice: "Not authorized!" if @location.nil?
  end
  ...
  private
    ...
    def location_params
      params.require(:location).permit(:name, :user_id, :global)
    end
end
