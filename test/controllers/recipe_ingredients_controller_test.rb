...
class RecipeIngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipe_ingredient" do
    assert_difference("RecipeIngredient.count") do
      post recipe_ingredients_url, params: { recipe_ingredient: { global: @recipe_ingredient.global, ingredient_id: @recipe_ingredient.ingredient_id, prep_instructions: @recipe_ingredient.prep_instructions, recipe_id: @recipe_ingredient.recipe_id, unit_id: @recipe_ingredient.unit_id, user_id: @recipe_ingredient.user_id } }
    end
  ...
  test "should update recipe_ingredient" do
    patch recipe_ingredient_url(@recipe_ingredient), params: { recipe_ingredient: { global: @recipe_ingredient.global, ingredient_id: @recipe_ingredient.ingredient_id, prep_instructions: @recipe_ingredient.prep_instructions, recipe_id: @recipe_ingredient.recipe_id, unit_id: @recipe_ingredient.unit_id, user_id: @recipe_ingredient.user_id } }
