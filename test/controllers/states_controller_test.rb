...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference("State.count") do
      post states_url, params: { state: { global: @state.global, name: @state.name, the_key: @state.the_key, user_id_integer: @state.user_id_integer } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { global: @state.global, name: @state.name, the_key: @state.the_key, user_id_integer: @state.user_id_integer } }
